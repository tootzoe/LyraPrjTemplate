...
echo "$0 clr              ==> Cleanup current project...."
echo
...
{
    if [ -f $UEPRJROOT/Source/${TARGETFULLNAME} ]; then
        echo "Error!! $UEPRJROOT/Source/${TARGETFULLNAME} already exist...."
        exit
    fi
...
EOF
    ...
    cat <<EOF > $UEPRJROOT/Source/${UPRO_BASENAME}Editor.Target.cs
// Generated by tootzoe utility script, create a base c++ game modular
...
/Volumes/UE5/uePrj/AdventureGameTemplate/Saved/StagedBuilds/Mac/AdventureTemplate-Mac-Shipping.app

echo :: Mac dev
echo $UE_FOLDER/Engine/Build/BatchFiles/RunUAT.command BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -project=\"$UPRO_PATHNAME\" -unrealexe=$UE_FOLDER/Engine/Binaries/Mac/UnrealEditor.app/Contents/MacOS/UnrealEditor -platform=Mac -SkipCookingErrorSummary  -SkipcookingEditorContent -build -cook -stage -package -pak -iostore -compressed -prereqs -clientconfig=Development -nocompile -nocompileuat -createreleaseversion="mac_1.0"
echo
echo ::  Mac shipping
echo $UE_FOLDER/Engine/Build/BatchFiles/RunUAT.command BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -project=\"$UPRO_PATHNAME\" -unrealexe=$UE_FOLDER/Engine/Binaries/Mac/UnrealEditor.app/Contents/MacOS/UnrealEditor -platform=Mac -SkipCookingErrorSummary  -SkipcookingEditorContent -build -cook -stage -package -pak -iostore -compressed -prereqs -distribution -clientconfig=Shipping -nodebuginfo -nocompile -nocompileuat -createreleaseversion="mac_1.0"

echo
echo ::  Mac Run app [ dev ]
echo    open \"$UEPRJROOT/Saved/StagedBuilds/Mac/$UPRO_BASENAME.app\" --args -game -log -windowed -resx=1280 -resy=720
echo    open \"$UEPRJROOT/Saved/StagedBuilds/Mac/$UPRO_BASENAME-Mac-Shipping.app\" --args -game -log -windowed -resx=1280 -resy=720
...
echo $UE_FOLDER/Engine/Build/BatchFiles/RunUAT.command BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -project=\"$UPRO_PATHNAME\" -unrealexe=$UE_FOLDER/Engine/Binaries/Mac/UnrealEditor.app/Contents/MacOS/UnrealEditor -platform=Android -cookflavor=$AND_FLAVOR -SkipCookingErrorSummary  -build -cook -stage -package -pak -iostore -compressed -prereqs -clientconfig=Development -nocompile -nocompileuat -SkipcookingEditorContent  -createreleaseversion="and_1.0" -archive -archivedirectory=\"$UEPRJROOT/tootbd/BaseRelease\"
echo
echo ::  Android shipping , flavor=$AND_FLAVOR
echo $UE_FOLDER/Engine/Build/BatchFiles/RunUAT.command BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -project=\"$UPRO_PATHNAME\" -unrealexe=$UE_FOLDER/Engine/Binaries/Mac/UnrealEditor.app/Contents/MacOS/UnrealEditor -platform=Android -cookflavor=$AND_FLAVOR -SkipCookingErrorSummary  -build -cook -stage -package -pak -iostore -compressed -prereqs -distribution -clientconfig=Shipping -nodebuginfo -nocompile -nocompileuat -SkipcookingEditorContent  -createreleaseversion="and_1.0" -archive -archivedirectory=\"$UEPRJROOT/tootbd/BaseReleaseShipping\"
