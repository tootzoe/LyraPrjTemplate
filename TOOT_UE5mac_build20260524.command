...
EOF
    ...
    cat <<EOF > $UEPRJROOT/Source/${TARGETFULLNAME}
// Generated by tootzoe utility script, create a base c++ game modular
...
echo
echo ::  iOS shipping
echo $UE_FOLDER/Engine/Build/BatchFiles/RunUAT.command BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -project=\"$UPRO_PATHNAME\" -unrealexe=$UE_FOLDER/Engine/Binaries/Mac/UnrealEditor.app/Contents/MacOS/UnrealEditor -platform=IOS -SkipCookingErrorSummary  -SkipcookingEditorContent -build -cook -stage -package -pak -iostore -compressed -prereqs -distribution -clientconfig=Shipping -nodebuginfo -nocompile -nocompileuat -createreleaseversion="ios_1.0" -archive -archivedirectory=\"$UEPRJROOT/tootbd/BaseReleaseShipping\"
echo
echo ::  iOS Archive
